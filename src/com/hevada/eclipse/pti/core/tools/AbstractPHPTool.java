...
package com.hevada.eclipse.pti.core.tools;
...
import com.hevada.eclipse.pti.core.listener.IResultListener;

public abstract class AbstractPHPTool {
	protected ListenerList<IResultListener> resultListenerList = new ListenerList<IResultListener>();
