...
package net.overscale.eclipse.pti.ui.viewsupport;
...
public abstract class ViewHistory {
	...
	/**
	 * @param entry
	 *            the entry to activate, or <code>null</code> if none should be
	 *            active
	 */
	 ...
	 *            all the remaining history entries, can be empty
	 * @param activeEntry
	 *            the entry to activate, or <code>null</code> if none should be
	 *            active
	 */
